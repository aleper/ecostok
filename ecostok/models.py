...
class Caixa(models.Model):
    id = models.CharField(primary_key=True, max_length=12, help_text='Id da Transação')
...
class Coletor(models.Model):
    ...
    pagamento = models.ForeignKey('Caixa',on_delete=models.PROTECT, help_text='Id da Transação')
    def __str__(self):
        return self.name
...
class Compra(models.Model):
    ...
    data = models.DateTimeField(auto_now=False, auto_now_add=True)
    peso = models.DecimalField(max_digits=3, decimal_places=2, help_text='Peso do Material Comprado Kg')
    prensado = models.DecimalField(max_digits=3, decimal_places=2, help_text='Peso do Material Prensado Kg')
